...
def test_predict(net, probe_path, gallery_path, pid_path, score_path):
    net = Model(inputs=[net.input], outputs=[net.get_layer('avg_pool').output])
    #net = Model(inputs=[net.input], outputs=[net.get_layer('fc8_2').output])
...
if __name__ == '__main__':
    ...
    model_path = '../new_trained_models/ResNet50/reid/softmax_loss/alternate_duke_0.0359133__weights.h5'
